...
const Profiles: React.FC = () => {
  ...
  const gen = async () => {
    ...
    try {
      ...
      if (roleToGenerate === "2") {
        if (!isAdmin) { addNotification("Apenas Admin pode gerar Supervisor", "warning"); return; }
        ...
        const tokenHex = Buffer.isBuffer(sent.result) ? Buffer.from(sent.result as any).toString("hex") : String(sent.result);
  ...
  const revoke = async () => {
    setMsg("");
    if (!isAdmin) { addNotification("Apenas Admin pode revogar", "warning"); return; }
    if (!revokeAddr) { setMsg("Endereço inválido"); addNotification("Endereço inválido", "error"); return; }
    ...
    showConfirmDialog(
      ...
      () => {
        ...
        void (async () => {
          try {
            await ownerRules.revoke_credential({ wallet: revokeAddr, role_id: revokeRole });
            setMsg("Revogado"); 
            addNotification("Credencial revogada", "success");
          } catch (e: any) {
            setMsg(e?.message || "Erro ao revogar");
            addNotification("Erro ao revogar", "error");
          }
        })();
      },
      'danger'
      ...
      <Layout.Inset>
        <div className="profiles-container">
          <div className="profiles-header">
            ...
            <Text as="h1" size="xl" className="profiles-title">Gestão de Perfis</Text>
            <Text as="p" size="md" className="profiles-subtitle">Crie e gerencie credenciais para usuários</Text>
          </div>
          ...
          {(isAdmin || isSupervisor) && (
            <div className="profile-card">
              <div className="card-header">
                ...
                <Text as="h2" size="lg" className="card-title">Geração de Credenciais</Text>
              </div>
                ...
                <div className="radio-group">
                  ...
                  <label className="futuristic-radio">
                    ...
                    <div className="radio-content">
                      ...
                      <div className="radio-description">Acesso básico ao sistema</div>
                    </div>
                  </label>
                  <label className="futuristic-radio">
                    <input 
                    ...
                    <div className="radio-content">
                      ...
                      <div className="radio-description">Gerenciamento de equipes</div>
                    </div>
                  </label>
                </div>
                ...
                {claimLink && (
                  <div className="result-box">
                    <div className="result-header">
                      ...
                      <span className="result-title">Link Gerado com Sucesso!</span>
                    </div>
