...
export const ContractWarning: React.FC<ContractWarningProps> = ({
  className = "",
}) => {
  ...
  return (
    <div
      className={`contract-warning ${className}`}
      style={{
    ...
    >
      ...
      <div>
        ...
        <p style={{ color: "#b7950b", margin: "4px 0 0 0", fontSize: "13px" }}>
          O administrador precisa configurar o contrato de eventos nas
          configurações para que todos os usuários possam acessar os eventos.
        </p>
      </div>
    </div>
  );
